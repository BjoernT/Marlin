...
#define STRING_VERSION_CONFIG_H __DATE__ STRING_VERSION __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "(Bjoern Teipel, For FolgerTech Prusa i3 Prusa Config)" //Who made the changes
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  //#define PID_dT ((OVERSAMPLENR * 10.0)/(F_CPU / 64.0 / 256.0)) //sampling period of the temperature routine, Ultimaker 
...
#define THERMAL_RUNAWAY_PROTECTION_HYSTERESIS 1 // in degree Celsius
...
//#define THERMAL_RUNAWAY_PROTECTION_BED_HYSTERESIS 1 // in degree Celsius
//===========================================================================
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,90}  // default steps per unit for ultimaker {78.7402,78.7402,200.0*8/3,760*1.1}
